...
// Flow map: matchId -> { winner: [targetMatchId, slotIndex], loser: [targetMatchId, slotIndex] }
...
export function BracketBuilder() {
  ...
  return (
    ...
    >
      ...
      />
      <SidebarInset>
        <header className="flex justify-between h-12 shrink-0 items-center gap-2 px-4">
          <div className="flex items-center gap-2">
            ...
            />
            <span className="text-sm font-medium">Double Elimination</span>
          </div>
        ...
        <div
          className="flex flex-1 items-center justify-center overflow-x-auto p-4 pt-0"
