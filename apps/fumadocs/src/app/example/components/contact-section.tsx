          ...
          <div className="space-y-6 order-2 lg:order-1">
            <Card className="hover:shadow-md transition-shadow cursor-pointer">
              ...
              <CardContent>
                ...
                <Button variant="outline" size="sm" className="cursor-pointer" render={<a href="https://discord.com/invite/XEQhPc9a6p" target="_blank" rel="noopener noreferrer" />}>
                  Join Discord
                </Button>
              </CardContent>
            </Card>
            ...
            <Card className="hover:shadow-md transition-shadow cursor-pointer">
              ...
              <CardContent>
                ...
                <Button variant="outline" size="sm" className="cursor-pointer" render={<a href="https://github.com/silicondeck/shadcn-dashboard-landing-template/issues" target="_blank" rel="noopener noreferrer" />}>
                  View on GitHub
                </Button>
              </CardContent>
            </Card>
            ...
            <Card className="hover:shadow-md transition-shadow cursor-pointer">
              ...
              <CardContent>
                ...
                <Button variant="outline" size="sm" className="cursor-pointer" render={<a href="#" />}>
                  View Docs
                </Button>
              </CardContent>
            </Card>
