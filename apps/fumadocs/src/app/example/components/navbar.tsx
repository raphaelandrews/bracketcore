    ...
    <header className="sticky top-0 z-50 w-full border-b bg-background/80 backdrop-blur-xl supports-[backdrop-filter]:bg-background/60">
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 flex h-16 items-center justify-between">
        ...
        <div className="hidden xl:flex items-center space-x-2">
          ...
          <Button variant="ghost" size="icon" className="cursor-pointer" render={<a href="https://github.com/silicondeck/shadcn-dashboard-landing-template" target="_blank" rel="noopener noreferrer" aria-label="GitHub Repository" />}>
            <Github className="h-5 w-5" />
          </Button>
          <Button variant="outline" className="cursor-pointer" render={<Link href="/dashboard" target="_blank" rel="noopener noreferrer" />}>
            <LayoutDashboard className="h-4 w-4 mr-2" />
            Dashboard
          </Button>
          <Button variant="ghost" className="cursor-pointer" render={<Link href="/auth/sign-in" />}>
            Sign In
          </Button>
          <Button className="cursor-pointer" render={<Link href="/auth/sign-up" />}>
            Get Started
          </Button>
        </div>
            ...
            <div className="flex flex-col h-full">
              <SheetHeader className="space-y-0 p-4 pb-2 border-b">
                <div className="flex items-center gap-2">
                  ...
                  <div className="ml-auto flex items-center gap-2">
                    ...
                    <Button variant="ghost" size="icon" className="cursor-pointer h-8 w-8" render={<a href="https://github.com/silicondeck/shadcn-dashboard-landing-template" target="_blank" rel="noopener noreferrer" aria-label="GitHub Repository" />}>
              ...
              <div className="border-t p-6 space-y-4">
                ...
                <div className="space-y-3">
                  <Button variant="outline" size="lg" className="w-full cursor-pointer" render={<Link href="/dashboard" />}>
                    <LayoutDashboard className="size-4" />
                    Dashboard
                  </Button>

                  <div className="grid grid-cols-2 gap-3">
                    <Button variant="outline" size="lg" className="cursor-pointer" render={<Link href="/auth/sign-in" />}>
                      Sign In
                    </Button>
                    <Button size="lg" className="cursor-pointer" render={<Link href="/auth/sign-up" />}>
                      Get Started
                    </Button>
                  </div>
                </div>
