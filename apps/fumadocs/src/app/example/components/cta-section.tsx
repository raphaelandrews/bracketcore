          ...
          <div className='text-center'>
            <div className='space-y-8'>
              ...
              <div className='flex flex-col justify-center gap-4 sm:flex-row sm:gap-6'>
                <Button size='lg' className='cursor-pointer px-8 py-6 text-lg font-medium' render={<a href='https://shadcnstore.com/blocks' target='_blank' rel='noopener noreferrer' />}>
                  <Package className='me-2 size-5' />
                  Browse Components
                </Button>
                <Button variant='outline' size='lg' className='cursor-pointer px-8 py-6 text-lg font-medium group' render={<a href='https://github.com/silicondeck/shadcn-dashboard-landing-template' target='_blank' rel='noopener noreferrer' />}>
