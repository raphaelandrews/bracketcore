      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        <div className="mx-auto max-w-2xl text-center mb-12">
          ...
          <div className="flex items-center justify-center mb-2">
            <ToggleGroup
              ...
              onValueChange={(value) => {
                if (value.includes("yearly")) setIsYearly(true)
                else if (value.includes("monthly")) setIsYearly(false)
              }}
        ...
        <div className="mt-16 text-center">
          <p className="text-muted-foreground">
            ...
            <Button variant="link" className="p-0 h-auto cursor-pointer" render={<a href="#contact" />}>
              Contact our team
            </Button>
          </p>
        </div>
