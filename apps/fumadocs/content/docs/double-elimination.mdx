...
<ComponentPreview code={`import { DoubleElimination } from "@/components/bracketcore/double-elimination"
import type { DoubleEliminationBracket, Match } from "@/types/bracketcore"
...
export function DoubleEliminationDemo() {
...
```tsx
import { DoubleElimination } from "@/components/bracketcore/double-elimination";
import type { DoubleEliminationBracket } from "@/types/bracketcore";
```
...
<ComponentPreview code={`const bracket: DoubleEliminationBracket = {
  type: "double-elimination",
  upper: [
    {
      name: "UB Round 1",
...
export function DoubleEliminationRatio2Demo() {
  return <DoubleElimination bracket={bracket} />
}
`}>
...
export function DoubleEliminationLBStartsEarlierDemo() {
  return <DoubleElimination bracket={bracket} ubAlignToLBRound={1} />
}
`}>
...
<ComponentPreview
  code={`export function DoubleEliminationSimpleDemo() {
  return <DoubleElimination bracket={bracket} connectorStyle="simple" />
}
`}
>
